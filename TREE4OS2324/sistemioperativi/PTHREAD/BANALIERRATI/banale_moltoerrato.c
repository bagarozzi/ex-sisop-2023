...
int fai_qualcosa_nello_stack( void ) {
	...
	/* le seguenti variabili si sovrapporranno nello stack
	   alla variabile t dichiarata nella funzione crea_threads
	   provocando modifiche inaspettate nella variabile t
	*/
